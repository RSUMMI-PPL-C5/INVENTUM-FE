...
export default function SparePartDetails() {
  ...
  return (
    <div className="space-y-6" data-testid="spare-part-detail">
      ...
      {/* Spare part details */}
      <div className="border rounded-lg p-6 shadow-sm">
        <h1 className="text-2xl font-bold mb-6" data-testid="spare-part-name">
          {sparepart.partsName}
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm" data-testid="spare-part-location">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm" data-testid="spare-part-description">
