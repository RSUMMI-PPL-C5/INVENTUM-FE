...
export default function SparePartDetails() {
	...
	const handleDelete = async () => {
		...
		try {
			...
			setIsDeleting(false);
			// No need to close the dialog here as the component will get unmounted on successful deletion
			// If there's an error, we want to keep it open for the user to try again
		}
	};
