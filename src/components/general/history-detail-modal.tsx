      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-4">
          <div className="grid grid-cols-2 gap-4">
            <DetailItem label="Deskripsi" value={data.actionPerformed} />
            ...
            <DetailItem label="Dibuat Oleh" value={data.createdBy} />
            <DetailItem label="Dibuat Pada" value={formatDate(data.createdOn)} />
          </div>
        </div>
      </DialogContent>
    </Dialog>
