...
export default function CalibrationHistoryFilterModal({
  ...
  const [localFilters, setLocalFilters] = useState<CalibrationHistoryFilters>(filters)

  useEffect(() => {
    setLocalFilters(filters)
  }, [filters])

  const handleChange = (field: keyof CalibrationHistoryFilters, value: string | Date | null) => {
    ...
    <Dialog open={isOpen} onOpenChange={onCancel}>
      <DialogContent className="sm:max-w-[625px]">
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label className="text-right">Tanggal Kalibrasi</Label>
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label className="text-right">Kalibrasi Berikutnya</Label>
