...
const menuItems: MenuItem[] = [
	{ label: "Pengguna", icon: <TwoUsers set="curved" stroke="bold" filled />, route: "/dashboard/user" },
	{ label: "Daftar Alat Medis", icon: <Heart2 set="curved" stroke="bold" filled />, route: "/dashboard/medical-equipment" },
	{ label: "Daftar Suku Cadang", icon: <Category set="curved" stroke="bold" filled />, route: "/dashboard/spare-part" },
	{ label: "Permintaan Maintenance", icon: <Setting set="curved" stroke="bold" filled />, route: "/dashboard/maintenance-request" },
	{ label: "Permintaan Kalibrasi", icon: <Chart set="curved" stroke="bold" filled />, route: "/dashboard/calibration-request" },
	{ label: "Laporan", icon: <Activity set="curved" stroke="bold" filled />, route: "/dashboard/report" },
];
				...
				<div className="flex px-2 py-3 gap-3 bg-white rounded-lg w-full text-nowrap shadow-[0px_0px_100px_0px_rgba(0,0,0,0.10)]">
					...
					{isHovered && (
						<div className="flex flex-col w-fit truncate">
							<span className="text-s-semibold truncate">Azmy Arya Rizaldi</span>
